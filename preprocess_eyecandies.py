...
# 对 Eyecandies 数据集进行预处理。它将原始数据集中的深度图像转换为点云，移除背景点，然后将其保存为 .tiff 文件
if __name__ == '__main__':

    parser = argparse.ArgumentParser(description='Process some integers.')
    parser.add_argument('--dataset_path', default='/root/workspaces/SSL-MIAD/datasets/Eyecandies', type=str, help="Original Eyecandies dataset path.")
    parser.add_argument('--target_dir', default='/root/workspaces/SSL-MIAD/datasets/Eyecandies_preprocessed', type=str, help="Processed Eyecandies dataset path")
